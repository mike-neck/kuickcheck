...
internal class ListGenerator<out T>(
    ...
    override fun overrideSize(newSize: Int): Generator<List<T>> =
            ListGenerator(elementGenerator, newSize, false)

    override fun fix(newSize: Int): Generator<List<T>> =
            ListGenerator(elementGenerator, newSize, true)

    override fun invoke(): List<T> {
        return sizeGenerator.of { elementGenerator() }
    }
}
